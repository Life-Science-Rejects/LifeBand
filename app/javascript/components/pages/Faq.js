      ...
      <div className="faq">
        <h3>Frequently Asked Questions</h3>
          ...
          <ol>
            ...
            <li>
              Create your profile when prompted on the Home page. <span>Remember, typing your full name acts as a signature, and upon submitting this form, you agree to release your personal medical information under HIPAA!</span> Not comfortable sharing some information publicly? Simply omit the field. You can always edit this information on My Profile too, if you ever change your mind!
            </li>
            <li>
              Navigate to My Profile
            </li>
            <li>
              Add your emergency contacts. You can always change these later, too!
            </li>
            <li>
              Find your unique QR code on My Profile. Screenshot this, save it on your phone or leave a print in your wallet, and share it with your friends and family.
            </li>
            <li>
              In your times of need, anybody with this QR code can access your profile and view your vital medical information. It's that easy!
            </li>
          </ol>
