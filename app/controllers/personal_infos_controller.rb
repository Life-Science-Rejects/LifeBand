class PersonalInfosController < ApplicationController
    ...
    def personal_info_params
        params.require(:personal_info).permit(:full_name, :gender, :phone_number, :allergy, :medical_history, :treatment_refusal, :pregnancy_status, :smoker, :alcohol, :recreational_drug, :menstruation, :code_status, :medical_condition, :diagnosis_date, :medication, :dosage, :user_id)
    end
end
